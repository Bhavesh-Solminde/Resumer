                    ...
                    {(item.githubLink || editingLink?.itemId === item.id && editingLink?.type === "github") && (
                      editingLink?.itemId === item.id && editingLink?.type === "github" ? (
                        <input
                          ...
                          className="text-xs border border-indigo-300 rounded px-1.5 py-0.5 w-40 focus:outline-none focus:ring-1 focus:ring-indigo-400"
                        />
                      ) : (
                        <a
                          ...
                          className="inline-flex items-center gap-1 text-xs text-indigo-600 hover:text-indigo-700 hover:underline cursor-pointer"
                        >
