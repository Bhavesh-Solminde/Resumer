    ...
    <div className="fixed inset-0 z-[100] flex flex-col items-center justify-center overflow-hidden bg-background">
      ...
      <div className="relative z-20 flex flex-col items-center justify-center max-w-2xl px-4 w-full">
        <AnimatePresence mode="wait">
          ...
          >
            <h2 className="text-2xl md:text-4xl lg:text-5xl font-bold text-transparent bg-clip-text bg-gradient-to-b from-neutral-800 to-neutral-500 dark:from-neutral-50 dark:to-neutral-400 mb-2 md:mb-4 px-2">
              {loadingStates[currentState].text}
            </h2>
            <p className="text-neutral-500 dark:text-neutral-400 text-xs md:text-sm font-medium tracking-widest uppercase">
        ...
        {/* Progress Bar */}
        <div className="w-full max-w-[280px] md:max-w-xs h-1 bg-neutral-200 dark:bg-neutral-800 mt-8 md:mt-12 rounded-full overflow-hidden relative">
          <motion.div
